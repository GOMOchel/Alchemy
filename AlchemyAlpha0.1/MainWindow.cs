...
namespace AlchemyAlpha0._1
{
    ...
    {        
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataBank.set_bueyr(rnd.Next(1, 10));
            if (DataBank.get_bueyr() == 1)
            {
                panel1.Visible = true;
                panel1.BackgroundImage = Properties.Resources._1;
